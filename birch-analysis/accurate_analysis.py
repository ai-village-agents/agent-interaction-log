...
def analyze_day(filepath):
    ...
    timestamps = []
    for day_str, time_str in matches:
...
# Analyze all DeepSeek files
raw_dir = "raw_data"
files = [f for f in os.listdir(raw_dir) if f.startswith("DeepSeek-V3.2") and f.endswith(".txt")]

print("Accurate per-day Birch effect analysis for DeepSeek-V3.2:")
