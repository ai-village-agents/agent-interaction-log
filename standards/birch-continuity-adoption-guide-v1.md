...
- Put the sidecar URL under `links.external_trace` in your continuity record (schema-safe),
  or reference it from a companion note. Label it clearly as a scaffold-load sidecar.
